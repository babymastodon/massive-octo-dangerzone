...
public class TestSystem{
     ...
     * 
     * Several clients same username: Single client logs in with username “user1”.
     * Another client then tries to login with username “user1”. The second client should be told that
     * it must choose a different username.
     * 
