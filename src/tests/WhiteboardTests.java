...
public class WhiteboardTests {
    ...
    public void testInitialColorsWhite(){
        ...
        for (int i = 0; i < Whiteboard.HEIGHT; i ++){
            for (int j = 0; j < Whiteboard.WIDTH; j ++){
    ...
    public void drawLineSamePoint(){
        ...
        Color white = new Color();
        Point[] expectedPoints = {new Point(20, 65)};
        Point[] modifiedPoints = wb.drawLine(new Point(20, 65), new Point(20, 65), newColor, 1);
        for (int i = 0; i < Whiteboard.HEIGHT; i ++){
            for (int j = 0; j < Whiteboard.WIDTH; j ++){
                Point p = new Point(i, j);
                if (i == 20 && j == 65){
        ...
        for (int i = 0; i < expectedPoints.length; i ++){
            assertEquals(true, expectedPoints[i].equals(modifiedPoints[i]));
        }
    }
     ...
     */
    private void testArraysEqual(ArrayList<Point> expectedPoints, Point[] modifiedPoints){
        assertEquals(modifiedPoints.length, expectedPoints.size());
        for (int i = 0; i < modifiedPoints.length; i ++){
            Point p = modifiedPoints[i];
    ...
    public void drawLineSamePointWidth(){
        ...
        Point[] modifiedPoints = wb.drawLine(new Point(100, 100), new Point(100, 100), newColor, 2);
        for (int i = 0; i < Whiteboard.HEIGHT; i ++){
            for (int j = 0; j < Whiteboard.WIDTH; j ++){
    ...
    public void drawLineVertical(){
        ...
        Point[] modifiedPoints = wb.drawLine(new Point(300, 200), new Point(300, 500), newColor, 1);
    ...
    public void drawLineVerticalWidth(){
        ...
        Point[] modifiedPoints = wb.drawLine(new Point(300, 200), new Point(300, 500), newColor, 3);
    ...
    public void drawLinePerfectDiagonal(){
        ...
        Point[] modifiedPoints = wb.drawLine(new Point(100, 100), new Point(200, 200), newColor, 1);
     ...
     */
     ...
     public void drawLineImperfectDiagonalUpRight(){
        ...
        Point[] modifiedPoints = wb.drawLine(new Point(100, 100), new Point(105, 300), newColor, 1);
